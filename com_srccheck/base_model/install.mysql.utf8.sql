...
-- -----------------------------------------------------
-- Table `mydb`.`#__crc_TrustedArchive`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`#__crc_TrustedArchive` (
...
-- -----------------------------------------------------
-- Table `mydb`.`#__crc_files_has_TrustedArchive`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`#__crc_files_has_TrustedArchive` (
  `crc_files_id` BIGINT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_crc_files_has_crc_TrustedArchive_crc_TrustedArchi2`
    ...
    REFERENCES `mydb`.`#__crc_TrustedArchive` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
